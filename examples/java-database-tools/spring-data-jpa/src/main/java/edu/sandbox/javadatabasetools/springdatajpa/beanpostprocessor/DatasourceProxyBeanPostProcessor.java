package edu.sandbox.javadatabasetools.springdatajpa.beanpostprocessor;
...
public class DatasourceProxyBeanPostProcessor implements BeanPostProcessor {
    ...
    private static class ProxyDataSourceInterceptor implements MethodInterceptor {
        ...
        public ProxyDataSourceInterceptor(final DataSource dataSource) {
            var basicFormatter = new BasicFormatterImpl();
            this.dataSource = ProxyDataSourceBuilder.create(dataSource)
                    .name("ProxyDataSource")
                    .multiline()
                    .countQuery()
                    .formatQuery(basicFormatter::format)
        ...
        public Object invoke(final MethodInvocation invocation) throws Throwable {
            var proxyMethod = ReflectionUtils.findMethod(this.dataSource.getClass(),
